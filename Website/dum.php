...
/*$rollno = $_POST['rollno'];
$pass = $_POST['password'];
$query = "SELECT * FROM customer WHERE RollNo='$rollno'and Password='$pass' ";
...
{
    if($_POST['rollno'] == $rollno1 && $_POST['password'] == $pass1)
    {
...
<body>
  ...
  <div class="main">
    ...
    <div class="form">
      ...
      <form method="POST" action="dum.php" id="contact-form" class="form">
